...
{
    var pathtojsfiles = "/siapdana/js/jqgrid/"; // need to be ajusted
    ...
    var minver = false;
    var modules = [
        { include: true, incfile:'grid.locale-id.js'}, // jqGrid translation
/*        { include: true, incfile:'grid.pack.js',minfile: ''},  */ // jqGrid all packecd
        ...
        { include: true, incfile:'jqModal.js',minfile: 'min/jqModal.js'},
        { include: true, incfile:'jqDnR.js',minfile: 'min/jqDnR.js'},
        { include: true, incfile:'jquery.tablednd.js',minfile: 'min/jquery.tablednd.js'},
        { include: true, incfile:'styleswitch.js',minfile: 'min/styleswitch.js'}
    ];
    var filename;
